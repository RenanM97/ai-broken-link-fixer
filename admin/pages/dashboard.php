 ...
 *
 * Included by ABLF_Admin::render_page(), which capability-gates the request and
 * inherits the admin nonce context. Variables in this file are local to the
 * included template scope, not true globals — PrefixAllGlobals false-positives.
 */
...
// Read-only navigation state. Status is validated against a fixed whitelist on the
// next line; no DB writes or side effects occur from this value. No nonce needed.
