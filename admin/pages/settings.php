<?php
/**
 * Settings page template. Included by ABLF_Admin::render_page() which already
...
<div class="wrap ablf-wrap">
	...
	<?php
	// "settings-updated" is set by WordPress core after a successful options.php save;
	// it is not a security-sensitive parameter and never causes state changes.
